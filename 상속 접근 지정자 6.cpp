...
// protected 상속(public => protected, protected => protected, private => private) 
...
public:
	...
	void rrint() {
		cout << "private : " << pri << endl; // private은 상속되지 않으므로 자식에서 접근할 수 없음. 
		cout << "protected : " << pro << endl; // protected는 자식에서 접근할 수 있으므로 가능 
		cout << "public : " << pub << endl; // protected은 자식에서 접근할 수 있으므로 가능  
	}
};
...
int main() {
	...
	cout << dog.pub << endl << endl; // protected는 외부에서 접근 불가능  

	cout << "[함수에서의 접근]" << endl;
	dog.print(); // protected 상속에 의해 print는 더 이상 public이 아님. => 외부에서 접근 불가능 
	cout << endl;
